...
<div class="space-y-6">
	...
	{#if showCreateForm}
		<div class="bg-bg-tertiary rounded-lg p-5 border border-bg-modifier">
			...
			<div class="space-y-4">
				<div>
					<label for="retention-scope" class="block text-sm font-medium text-text-secondary mb-2">Scope</label>
					<div id="retention-scope" class="flex gap-4" role="radiogroup" aria-label="Retention scope">
