...
<div class="giphy-picker fixed inset-x-0 bottom-0 z-50 max-h-[60vh] rounded-t-xl bg-bg-floating shadow-xl md:absolute md:inset-auto md:bottom-full md:right-0 md:mb-2 md:w-80 md:max-h-none md:rounded-lg" role="dialog" aria-label="GIF picker">
	<!-- Search bar -->
